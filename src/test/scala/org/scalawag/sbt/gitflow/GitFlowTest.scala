...
class GitFlowTest extends FunSuite with Matchers with BeforeAndAfterAll {
  ...
  val refToVersion = Map(
    ...
    "release/0.3" -> "0.3.0-SNAPSHOT",
    "0.1" -> "0.1",
    "feature/exp" -> "0.5.0-exp-SNAPSHOT",
    ...
    "ea6f07fa5c855b96be6dfa16ea6271a906ff06d0" -> "0.5.0-exp-SNAPSHOT", // Feature branch
    "210a1d024f5b70a8511475bf722bf221df23e6fc" -> "0.3.0-SNAPSHOT", // Release branch
